#[doc = "Register `PRIC_IO24C` reader"]
pub type R = crate::R<PricIo24cSpec>;
#[doc = "Register `PRIC_IO24C` writer"]
pub type W = crate::W<PricIo24cSpec>;
#[doc = "Field `Reserved31` reader - Reserved"]
pub type Reserved31R = crate::BitReader;
#[doc = "Field `Reserved31` writer - Reserved"]
pub type Reserved31W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `Reserved30` reader - Reserved"]
pub type Reserved30R = crate::BitReader;
#[doc = "Field `Reserved30` writer - Reserved"]
...
impl R {
    ...
    pub fn reserved31(&self) -> Reserved31R {
        Reserved31R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Reserved"]
    #[inline(always)]
    pub fn reserved30(&self) -> Reserved30R {
        Reserved30R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn reserved31(&mut self) -> Reserved31W<PricIo24cSpec> {
        Reserved31W::new(self, 0)
    }
    #[doc = "Bit 1 - Reserved"]
    #[inline(always)]
    pub fn reserved30(&mut self) -> Reserved30W<PricIo24cSpec> {
        Reserved30W::new(self, 1)
    }
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn reserved29(&mut self) -> Reserved29W<PricIo24cSpec> {
        Reserved29W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn reserved28(&mut self) -> Reserved28W<PricIo24cSpec> {
        Reserved28W::new(self, 3)
    }
    #[doc = "Bit 4 - Reserved"]
    #[inline(always)]
    pub fn reserved27(&mut self) -> Reserved27W<PricIo24cSpec> {
        Reserved27W::new(self, 4)
    }
    #[doc = "Bit 5 - Reserved"]
    #[inline(always)]
    pub fn reserved26(&mut self) -> Reserved26W<PricIo24cSpec> {
        Reserved26W::new(self, 5)
    }
    #[doc = "Bit 6 - Reserved"]
    #[inline(always)]
    pub fn reserved25(&mut self) -> Reserved25W<PricIo24cSpec> {
        Reserved25W::new(self, 6)
    }
    #[doc = "Bit 7 - Reserved"]
    #[inline(always)]
    pub fn reserved24(&mut self) -> Reserved24W<PricIo24cSpec> {
        Reserved24W::new(self, 7)
    }
    #[doc = "Bit 8 - Reserved"]
    #[inline(always)]
    pub fn reserved23(&mut self) -> Reserved23W<PricIo24cSpec> {
        Reserved23W::new(self, 8)
    }
    #[doc = "Bit 9 - Reserved"]
    #[inline(always)]
    pub fn reserved22(&mut self) -> Reserved22W<PricIo24cSpec> {
        Reserved22W::new(self, 9)
    }
    #[doc = "Bit 10 - Reserved"]
    #[inline(always)]
    pub fn reserved21(&mut self) -> Reserved21W<PricIo24cSpec> {
        Reserved21W::new(self, 10)
    }
    #[doc = "Bit 11 - Reserved"]
    #[inline(always)]
    pub fn reserved20(&mut self) -> Reserved20W<PricIo24cSpec> {
        Reserved20W::new(self, 11)
    }
    #[doc = "Bit 12 - Reserved"]
    #[inline(always)]
    pub fn reserved19(&mut self) -> Reserved19W<PricIo24cSpec> {
        Reserved19W::new(self, 12)
    }
    #[doc = "Bit 13 - Reserved"]
    #[inline(always)]
    pub fn reserved18(&mut self) -> Reserved18W<PricIo24cSpec> {
        Reserved18W::new(self, 13)
    }
    #[doc = "Bit 14 - Reserved"]
    #[inline(always)]
    pub fn reserved17(&mut self) -> Reserved17W<PricIo24cSpec> {
        Reserved17W::new(self, 14)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn reserved16(&mut self) -> Reserved16W<PricIo24cSpec> {
        Reserved16W::new(self, 15)
    }
    #[doc = "Bit 16 - Reserved"]
    #[inline(always)]
    pub fn reserved15(&mut self) -> Reserved15W<PricIo24cSpec> {
        Reserved15W::new(self, 16)
    }
    #[doc = "Bit 17 - Reserved"]
    #[inline(always)]
    pub fn reserved14(&mut self) -> Reserved14W<PricIo24cSpec> {
        Reserved14W::new(self, 17)
    }
    #[doc = "Bit 18 - Reserved"]
    #[inline(always)]
    pub fn reserved13(&mut self) -> Reserved13W<PricIo24cSpec> {
        Reserved13W::new(self, 18)
    }
    #[doc = "Bit 19 - Reserved"]
    #[inline(always)]
    pub fn reserved12(&mut self) -> Reserved12W<PricIo24cSpec> {
        Reserved12W::new(self, 19)
    }
    #[doc = "Bit 20 - Reserved"]
    #[inline(always)]
    pub fn reserved11(&mut self) -> Reserved11W<PricIo24cSpec> {
        Reserved11W::new(self, 20)
    }
    #[doc = "Bit 21 - Reserved"]
    #[inline(always)]
    pub fn reserved10(&mut self) -> Reserved10W<PricIo24cSpec> {
        Reserved10W::new(self, 21)
    }
    #[doc = "Bit 22 - Reserved"]
    #[inline(always)]
    pub fn reserved9(&mut self) -> Reserved9W<PricIo24cSpec> {
        Reserved9W::new(self, 22)
    }
    #[doc = "Bit 23 - Reserved"]
    #[inline(always)]
    pub fn reserved8(&mut self) -> Reserved8W<PricIo24cSpec> {
        Reserved8W::new(self, 23)
    }
    #[doc = "Bit 24 - Reserved"]
    #[inline(always)]
    pub fn reserved7(&mut self) -> Reserved7W<PricIo24cSpec> {
        Reserved7W::new(self, 24)
    }
    #[doc = "Bit 25 - Reserved"]
    #[inline(always)]
    pub fn reserved6(&mut self) -> Reserved6W<PricIo24cSpec> {
        Reserved6W::new(self, 25)
    }
    #[doc = "Bit 26 - Reserved"]
    #[inline(always)]
    pub fn reserved5(&mut self) -> Reserved5W<PricIo24cSpec> {
        Reserved5W::new(self, 26)
    }
    #[doc = "Bit 27 - Reserved"]
    #[inline(always)]
    pub fn reserved4(&mut self) -> Reserved4W<PricIo24cSpec> {
        Reserved4W::new(self, 27)
    }
    #[doc = "Bit 28 - Reserved"]
    #[inline(always)]
    pub fn reserved3(&mut self) -> Reserved3W<PricIo24cSpec> {
        Reserved3W::new(self, 28)
    }
    #[doc = "Bit 29 - Reserved"]
    #[inline(always)]
    pub fn reserved2(&mut self) -> Reserved2W<PricIo24cSpec> {
        Reserved2W::new(self, 29)
    }
    #[doc = "Bit 30 - Reserved"]
    #[inline(always)]
    pub fn reserved1(&mut self) -> Reserved1W<PricIo24cSpec> {
        Reserved1W::new(self, 30)
    }
}
#[doc = "Slave Write Group Setting Register \\#19\n\nYou can [`read`](crate::Reg::read) this register and get [`pric_io24c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pric_io24c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PricIo24cSpec;
impl crate::RegisterSpec for PricIo24cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pric_io24c::R`](R) reader structure"]
impl crate::Readable for PricIo24cSpec {}
#[doc = "`write(|w| ..)` method takes [`pric_io24c::W`](W) writer structure"]
impl crate::Writable for PricIo24cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PRIC_IO24C to value 0x3f3f_3f3f"]
impl crate::Resettable for PricIo24cSpec {
