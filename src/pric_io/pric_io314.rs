#[doc = "Register `PRIC_IO314` reader"]
pub type R = crate::R<PricIo314Spec>;
#[doc = "Register `PRIC_IO314` writer"]
pub type W = crate::W<PricIo314Spec>;
...
impl W {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn reserved25(&mut self) -> Reserved25W<PricIo314Spec> {
        Reserved25W::new(self, 0)
    }
    #[doc = "Bit 1 - Reserved"]
    #[inline(always)]
    pub fn reserved24(&mut self) -> Reserved24W<PricIo314Spec> {
        Reserved24W::new(self, 1)
    }
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn reserved23(&mut self) -> Reserved23W<PricIo314Spec> {
        Reserved23W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn reserved22(&mut self) -> Reserved22W<PricIo314Spec> {
        Reserved22W::new(self, 3)
    }
    #[doc = "Bit 4 - Reserved"]
    #[inline(always)]
    pub fn reserved21(&mut self) -> Reserved21W<PricIo314Spec> {
        Reserved21W::new(self, 4)
    }
    #[doc = "Bit 5 - Reserved"]
    #[inline(always)]
    pub fn reserved20(&mut self) -> Reserved20W<PricIo314Spec> {
        Reserved20W::new(self, 5)
    }
    #[doc = "Bit 6 - Reserved"]
    #[inline(always)]
    pub fn reserved19(&mut self) -> Reserved19W<PricIo314Spec> {
        Reserved19W::new(self, 6)
    }
    #[doc = "Bit 7 - Reserved"]
    #[inline(always)]
    pub fn reserved18(&mut self) -> Reserved18W<PricIo314Spec> {
        Reserved18W::new(self, 7)
    }
    #[doc = "Bit 8 - Reserved"]
    #[inline(always)]
    pub fn reserved17(&mut self) -> Reserved17W<PricIo314Spec> {
        Reserved17W::new(self, 8)
    }
    #[doc = "Bit 9 - Reserved"]
    #[inline(always)]
    pub fn reserved16(&mut self) -> Reserved16W<PricIo314Spec> {
        Reserved16W::new(self, 9)
    }
    #[doc = "Bit 10 - Reserved"]
    #[inline(always)]
    pub fn reserved15(&mut self) -> Reserved15W<PricIo314Spec> {
        Reserved15W::new(self, 10)
    }
    #[doc = "Bit 11 - Reserved"]
    #[inline(always)]
    pub fn reserved14(&mut self) -> Reserved14W<PricIo314Spec> {
        Reserved14W::new(self, 11)
    }
    #[doc = "Bit 12 - Reserved"]
    #[inline(always)]
    pub fn reserved13(&mut self) -> Reserved13W<PricIo314Spec> {
        Reserved13W::new(self, 12)
    }
    #[doc = "Bit 13 - Reserved"]
    #[inline(always)]
    pub fn reserved12(&mut self) -> Reserved12W<PricIo314Spec> {
        Reserved12W::new(self, 13)
    }
    #[doc = "Bit 14 - Reserved"]
    #[inline(always)]
    pub fn reserved11(&mut self) -> Reserved11W<PricIo314Spec> {
        Reserved11W::new(self, 14)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn reserved10(&mut self) -> Reserved10W<PricIo314Spec> {
        Reserved10W::new(self, 15)
    }
    #[doc = "Bit 16 - Reserved"]
    #[inline(always)]
    pub fn reserved9(&mut self) -> Reserved9W<PricIo314Spec> {
        Reserved9W::new(self, 16)
    }
    #[doc = "Bit 17 - Reserved"]
    #[inline(always)]
    pub fn reserved8(&mut self) -> Reserved8W<PricIo314Spec> {
        Reserved8W::new(self, 17)
    }
    #[doc = "Bit 18 - Reserved"]
    #[inline(always)]
    pub fn reserved7(&mut self) -> Reserved7W<PricIo314Spec> {
        Reserved7W::new(self, 18)
    }
    #[doc = "Bit 19 - Reserved"]
    #[inline(always)]
    pub fn reserved6(&mut self) -> Reserved6W<PricIo314Spec> {
        Reserved6W::new(self, 19)
    }
    #[doc = "Bit 20 - Reserved"]
    #[inline(always)]
    pub fn reserved5(&mut self) -> Reserved5W<PricIo314Spec> {
        Reserved5W::new(self, 20)
    }
    #[doc = "Bit 21 - Reserved"]
    #[inline(always)]
    pub fn reserved4(&mut self) -> Reserved4W<PricIo314Spec> {
        Reserved4W::new(self, 21)
    }
    #[doc = "Bit 22 - Reserved"]
    #[inline(always)]
    pub fn reserved3(&mut self) -> Reserved3W<PricIo314Spec> {
        Reserved3W::new(self, 22)
    }
    #[doc = "Bit 23 - Reserved"]
    #[inline(always)]
    pub fn reserved2(&mut self) -> Reserved2W<PricIo314Spec> {
        Reserved2W::new(self, 23)
    }
    #[doc = "Bits 24:30 - Reserved"]
    #[inline(always)]
    pub fn reserved1(&mut self) -> Reserved1W<PricIo314Spec> {
        Reserved1W::new(self, 24)
    }
}
#[doc = "Slave Read Group Setting Register \\#5\n\nYou can [`read`](crate::Reg::read) this register and get [`pric_io314::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pric_io314::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PricIo314Spec;
impl crate::RegisterSpec for PricIo314Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pric_io314::R`](R) reader structure"]
impl crate::Readable for PricIo314Spec {}
#[doc = "`write(|w| ..)` method takes [`pric_io314::W`](W) writer structure"]
impl crate::Writable for PricIo314Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PRIC_IO314 to value 0x3f3f_3f3f"]
impl crate::Resettable for PricIo314Spec {
