#[doc = "Register `ADC084` reader"]
pub type R = crate::R<Adc084Spec>;
#[doc = "Register `ADC084` writer"]
pub type W = crate::W<Adc084Spec>;
...
impl W {
    #[doc = "Bits 0:9 - Lower bound"]
    #[inline(always)]
    pub fn lower_bound(&mut self) -> LowerBoundW<Adc084Spec> {
        LowerBoundW::new(self, 0)
    }
    #[doc = "Bits 16:25 - Upper bound"]
    #[inline(always)]
    pub fn upper_bound(&mut self) -> UpperBoundW<Adc084Spec> {
        UpperBoundW::new(self, 16)
    }
    #[doc = "Bit 31 - Hysteresis Control"]
    #[inline(always)]
    pub fn hysteresis_ctrl(&mut self) -> HysteresisCtrlW<Adc084Spec> {
        HysteresisCtrlW::new(self, 31)
    }
}
#[doc = "Hysteresis Control and bound of Channel 5\n\nYou can [`read`](crate::Reg::read) this register and get [`adc084::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc084::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc084Spec;
impl crate::RegisterSpec for Adc084Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc084::R`](R) reader structure"]
impl crate::Readable for Adc084Spec {}
#[doc = "`write(|w| ..)` method takes [`adc084::W`](W) writer structure"]
impl crate::Writable for Adc084Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC084 to value 0"]
impl crate::Resettable for Adc084Spec {}
