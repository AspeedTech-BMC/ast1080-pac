#[doc = "Register `ADC08C` reader"]
pub type R = crate::R<Adc08cSpec>;
#[doc = "Register `ADC08C` writer"]
pub type W = crate::W<Adc08cSpec>;
...
impl W {
    #[doc = "Bits 0:9 - Lower bound"]
    #[inline(always)]
    pub fn lower_bound(&mut self) -> LowerBoundW<Adc08cSpec> {
        LowerBoundW::new(self, 0)
    }
    #[doc = "Bits 16:25 - Upper bound"]
    #[inline(always)]
    pub fn upper_bound(&mut self) -> UpperBoundW<Adc08cSpec> {
        UpperBoundW::new(self, 16)
    }
    #[doc = "Bit 31 - Hysteresis Control"]
    #[inline(always)]
    pub fn hysteresis_ctrl(&mut self) -> HysteresisCtrlW<Adc08cSpec> {
        HysteresisCtrlW::new(self, 31)
    }
}
#[doc = "Hysteresis Control and bound of Channel 7\n\nYou can [`read`](crate::Reg::read) this register and get [`adc08c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc08c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc08cSpec;
impl crate::RegisterSpec for Adc08cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc08c::R`](R) reader structure"]
impl crate::Readable for Adc08cSpec {}
#[doc = "`write(|w| ..)` method takes [`adc08c::W`](W) writer structure"]
impl crate::Writable for Adc08cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC08C to value 0"]
impl crate::Resettable for Adc08cSpec {}
