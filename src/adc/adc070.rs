#[doc = "Register `ADC070` reader"]
pub type R = crate::R<Adc070Spec>;
#[doc = "Register `ADC070` writer"]
pub type W = crate::W<Adc070Spec>;
...
impl W {
    #[doc = "Bits 0:9 - Lower bound"]
    #[inline(always)]
    pub fn lower_bound(&mut self) -> LowerBoundW<Adc070Spec> {
        LowerBoundW::new(self, 0)
    }
    #[doc = "Bits 16:25 - Upper bound"]
    #[inline(always)]
    pub fn upper_bound(&mut self) -> UpperBoundW<Adc070Spec> {
        UpperBoundW::new(self, 16)
    }
    #[doc = "Bit 31 - Hysteresis Control"]
    #[inline(always)]
    pub fn hysteresis_ctrl(&mut self) -> HysteresisCtrlW<Adc070Spec> {
        HysteresisCtrlW::new(self, 31)
    }
}
#[doc = "Hysteresis Control and bound of Channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`adc070::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc070::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc070Spec;
impl crate::RegisterSpec for Adc070Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc070::R`](R) reader structure"]
impl crate::Readable for Adc070Spec {}
#[doc = "`write(|w| ..)` method takes [`adc070::W`](W) writer structure"]
impl crate::Writable for Adc070Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC070 to value 0"]
impl crate::Resettable for Adc070Spec {}
