#[doc = "Register `ADC108` reader"]
pub type R = crate::R<Adc108Spec>;
#[doc = "Register `ADC108` writer"]
pub type W = crate::W<Adc108Spec>;
...
impl W {
    ...
    pub fn divisor_of_adcclk_used_for_vgadet(
        &mut self,
    ) -> DivisorOfAdcclkUsedForVgadetW<Adc108Spec> {
        DivisorOfAdcclkUsedForVgadetW::new(self, 0)
    }
    #[doc = "Bit 16 - ADC VGA detect enable"]
    #[inline(always)]
    pub fn adcvgadetect_enbl(&mut self) -> AdcvgadetectEnblW<Adc108Spec> {
        AdcvgadetectEnblW::new(self, 16)
    }
}
#[doc = "ADC VGA Detect Control\n\nYou can [`read`](crate::Reg::read) this register and get [`adc108::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc108::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc108Spec;
impl crate::RegisterSpec for Adc108Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc108::R`](R) reader structure"]
impl crate::Readable for Adc108Spec {}
#[doc = "`write(|w| ..)` method takes [`adc108::W`](W) writer structure"]
impl crate::Writable for Adc108Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC108 to value 0x0f"]
impl crate::Resettable for Adc108Spec {
