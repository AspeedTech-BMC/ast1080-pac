#[doc = "Register `ADC074` reader"]
pub type R = crate::R<Adc074Spec>;
#[doc = "Register `ADC074` writer"]
pub type W = crate::W<Adc074Spec>;
...
impl W {
    #[doc = "Bits 0:9 - Lower bound"]
    #[inline(always)]
    pub fn lower_bound(&mut self) -> LowerBoundW<Adc074Spec> {
        LowerBoundW::new(self, 0)
    }
    #[doc = "Bits 16:25 - Upper bound"]
    #[inline(always)]
    pub fn upper_bound(&mut self) -> UpperBoundW<Adc074Spec> {
        UpperBoundW::new(self, 16)
    }
    #[doc = "Bit 31 - Hysteresis Control"]
    #[inline(always)]
    pub fn hysteresis_ctrl(&mut self) -> HysteresisCtrlW<Adc074Spec> {
        HysteresisCtrlW::new(self, 31)
    }
}
#[doc = "Hysteresis Control and bound of Channel 1\n\nYou can [`read`](crate::Reg::read) this register and get [`adc074::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc074::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc074Spec;
impl crate::RegisterSpec for Adc074Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc074::R`](R) reader structure"]
impl crate::Readable for Adc074Spec {}
#[doc = "`write(|w| ..)` method takes [`adc074::W`](W) writer structure"]
impl crate::Writable for Adc074Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC074 to value 0"]
impl crate::Resettable for Adc074Spec {}
