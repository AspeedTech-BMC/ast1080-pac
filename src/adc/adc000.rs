#[doc = "Register `ADC000` reader"]
pub type R = crate::R<Adc000Spec>;
#[doc = "Register `ADC000` writer"]
pub type W = crate::W<Adc000Spec>;
...
#[doc = "Channel 7 Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Channel7sel {
    #[doc = "0: Normal Voltage"]
    NormalVoltage = 0,
    #[doc = "1: Battery"]
    Battery = 1,
}
impl From<Channel7sel> for bool {
    #[inline(always)]
    fn from(variant: Channel7sel) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `Channel7Sel` reader - Channel 7 Selection"]
pub type Channel7selR = crate::BitReader<Channel7sel>;
impl Channel7selR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Channel7sel {
        match self.bits {
            false => Channel7sel::NormalVoltage,
            true => Channel7sel::Battery,
        }
    }
    #[doc = "Normal Voltage"]
    #[inline(always)]
    pub fn is_normal_voltage(&self) -> bool {
        *self == Channel7sel::NormalVoltage
    }
    #[doc = "Battery"]
    #[inline(always)]
    pub fn is_battery(&self) -> bool {
        *self == Channel7sel::Battery
    }
}
#[doc = "Field `Channel7Sel` writer - Channel 7 Selection"]
pub type Channel7selW<'a, REG> = crate::BitWriter<'a, REG, Channel7sel>;
impl<'a, REG> Channel7selW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Normal Voltage"]
    ...
    pub fn normal_voltage(self) -> &'a mut crate::W<REG> {
        self.variant(Channel7sel::NormalVoltage)
    }
    #[doc = "Battery"]
    #[inline(always)]
    pub fn battery(self) -> &'a mut crate::W<REG> {
        self.variant(Channel7sel::Battery)
    }
}
...
impl R {
    ...
    #[doc = "Bit 12 - Channel 7 Selection"]
    #[inline(always)]
    pub fn channel7sel(&self) -> Channel7selR {
        Channel7selR::new(((self.bits >> 12) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Engine enable."]
    #[inline(always)]
    pub fn eng_enbl(&mut self) -> EngEnblW<Adc000Spec> {
        EngEnblW::new(self, 0)
    }
    #[doc = "Bits 1:3 - ADC Operation mode."]
    #[inline(always)]
    pub fn adcop_mode(&mut self) -> AdcopModeW<Adc000Spec> {
        AdcopModeW::new(self, 1)
    }
    #[doc = "Bit 4 - Compensating sensing mode."]
    #[inline(always)]
    pub fn compensating_sensing_mode(&mut self) -> CompensatingSensingModeW<Adc000Spec> {
        CompensatingSensingModeW::new(self, 4)
    }
    #[doc = "Bit 5 - Auto Compensating sensing mode."]
    #[inline(always)]
    pub fn auto_compensating_sensing_mode(&mut self) -> AutoCompensatingSensingModeW<Adc000Spec> {
        AutoCompensatingSensingModeW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Reference Voltage Selection"]
    #[inline(always)]
    pub fn reference_voltage_sel(&mut self) -> ReferenceVoltageSelW<Adc000Spec> {
        ReferenceVoltageSelW::new(self, 6)
    }
    #[doc = "Bit 12 - Channel 7 Selection"]
    #[inline(always)]
    pub fn channel7sel(&mut self) -> Channel7selW<Adc000Spec> {
        Channel7selW::new(self, 12)
    }
    #[doc = "Bit 13 - Enable Battery Sensing"]
    #[inline(always)]
    pub fn enbl_battery_sensing(&mut self) -> EnblBatterySensingW<Adc000Spec> {
        EnblBatterySensingW::new(self, 13)
    }
    #[doc = "Bits 16:23 - Channel enable."]
    #[inline(always)]
    pub fn channel_enbl(&mut self) -> ChannelEnblW<Adc000Spec> {
        ChannelEnblW::new(self, 16)
    }
}
#[doc = "Engine Control\n\nYou can [`read`](crate::Reg::read) this register and get [`adc000::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc000::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc000Spec;
impl crate::RegisterSpec for Adc000Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc000::R`](R) reader structure"]
impl crate::Readable for Adc000Spec {}
#[doc = "`write(|w| ..)` method takes [`adc000::W`](W) writer structure"]
impl crate::Writable for Adc000Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC000 to value 0"]
impl crate::Resettable for Adc000Spec {}
