#[doc = "Register `SGPIO014` reader"]
pub type R = crate::R<Sgpio014Spec>;
#[doc = "Register `SGPIO014` writer"]
pub type W = crate::W<Sgpio014Spec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#4\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio014::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio014::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio014Spec;
impl crate::RegisterSpec for Sgpio014Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio014::R`](R) reader structure"]
impl crate::Readable for Sgpio014Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio014::W`](W) writer structure"]
impl crate::Writable for Sgpio014Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO014 to value 0"]
impl crate::Resettable for Sgpio014Spec {}
