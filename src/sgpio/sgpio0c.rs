#[doc = "Register `SGPIO0C` reader"]
pub type R = crate::R<Sgpio0cSpec>;
#[doc = "Register `SGPIO0C` writer"]
pub type W = crate::W<Sgpio0cSpec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#2\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio0c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio0c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio0cSpec;
impl crate::RegisterSpec for Sgpio0cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio0c::R`](R) reader structure"]
impl crate::Readable for Sgpio0cSpec {}
#[doc = "`write(|w| ..)` method takes [`sgpio0c::W`](W) writer structure"]
impl crate::Writable for Sgpio0cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO0C to value 0"]
impl crate::Resettable for Sgpio0cSpec {}
