#[doc = "Register `SGPIO4C` reader"]
pub type R = crate::R<Sgpio4cSpec>;
#[doc = "Register `SGPIO4C` writer"]
pub type W = crate::W<Sgpio4cSpec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#3\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio4c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio4c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio4cSpec;
impl crate::RegisterSpec for Sgpio4cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio4c::R`](R) reader structure"]
impl crate::Readable for Sgpio4cSpec {}
#[doc = "`write(|w| ..)` method takes [`sgpio4c::W`](W) writer structure"]
impl crate::Writable for Sgpio4cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO4C to value 0"]
impl crate::Resettable for Sgpio4cSpec {}
