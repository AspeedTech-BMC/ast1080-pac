#[doc = "Register `SGPIO08` reader"]
pub type R = crate::R<Sgpio08Spec>;
#[doc = "Register `SGPIO08` writer"]
pub type W = crate::W<Sgpio08Spec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#1\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio08::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio08::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio08Spec;
impl crate::RegisterSpec for Sgpio08Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio08::R`](R) reader structure"]
impl crate::Readable for Sgpio08Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio08::W`](W) writer structure"]
impl crate::Writable for Sgpio08Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO08 to value 0"]
impl crate::Resettable for Sgpio08Spec {}
