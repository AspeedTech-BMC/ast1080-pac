#[doc = "Register `SGPIO024` reader"]
pub type R = crate::R<Sgpio024Spec>;
#[doc = "Register `SGPIO024` writer"]
pub type W = crate::W<Sgpio024Spec>;
...
impl W {}
#[doc = "Debug Serial Out Register \\#0\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio024::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio024::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio024Spec;
impl crate::RegisterSpec for Sgpio024Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio024::R`](R) reader structure"]
impl crate::Readable for Sgpio024Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio024::W`](W) writer structure"]
impl crate::Writable for Sgpio024Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO024 to value 0"]
impl crate::Resettable for Sgpio024Spec {}
