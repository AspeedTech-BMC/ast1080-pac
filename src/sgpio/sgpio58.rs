#[doc = "Register `SGPIO58` reader"]
pub type R = crate::R<Sgpio58Spec>;
#[doc = "Register `SGPIO58` writer"]
pub type W = crate::W<Sgpio58Spec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#6\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio58::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio58::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio58Spec;
impl crate::RegisterSpec for Sgpio58Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio58::R`](R) reader structure"]
impl crate::Readable for Sgpio58Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio58::W`](W) writer structure"]
impl crate::Writable for Sgpio58Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO58 to value 0"]
impl crate::Resettable for Sgpio58Spec {}
