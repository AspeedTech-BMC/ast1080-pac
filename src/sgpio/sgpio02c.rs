#[doc = "Register `SGPIO02C` reader"]
pub type R = crate::R<Sgpio02cSpec>;
#[doc = "Register `SGPIO02C` writer"]
pub type W = crate::W<Sgpio02cSpec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#2\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio02c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio02c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio02cSpec;
impl crate::RegisterSpec for Sgpio02cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio02c::R`](R) reader structure"]
impl crate::Readable for Sgpio02cSpec {}
#[doc = "`write(|w| ..)` method takes [`sgpio02c::W`](W) writer structure"]
impl crate::Writable for Sgpio02cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO02C to value 0"]
impl crate::Resettable for Sgpio02cSpec {}
