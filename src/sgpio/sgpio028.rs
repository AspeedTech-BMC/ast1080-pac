#[doc = "Register `SGPIO028` reader"]
pub type R = crate::R<Sgpio028Spec>;
#[doc = "Register `SGPIO028` writer"]
pub type W = crate::W<Sgpio028Spec>;
...
impl W {}
#[doc = "Debug Serial Out Register \\#1\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio028::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio028::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio028Spec;
impl crate::RegisterSpec for Sgpio028Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio028::R`](R) reader structure"]
impl crate::Readable for Sgpio028Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio028::W`](W) writer structure"]
impl crate::Writable for Sgpio028Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO028 to value 0"]
impl crate::Resettable for Sgpio028Spec {}
