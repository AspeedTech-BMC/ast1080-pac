#[doc = "Register `SGPIO44` reader"]
pub type R = crate::R<Sgpio44Spec>;
#[doc = "Register `SGPIO44` writer"]
pub type W = crate::W<Sgpio44Spec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#1\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio44::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio44::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio44Spec;
impl crate::RegisterSpec for Sgpio44Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio44::R`](R) reader structure"]
impl crate::Readable for Sgpio44Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio44::W`](W) writer structure"]
impl crate::Writable for Sgpio44Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO44 to value 0"]
impl crate::Resettable for Sgpio44Spec {}
