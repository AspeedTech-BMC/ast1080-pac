#[doc = "Register `SGPIO5C` reader"]
pub type R = crate::R<Sgpio5cSpec>;
#[doc = "Register `SGPIO5C` writer"]
pub type W = crate::W<Sgpio5cSpec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#7\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio5c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio5c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio5cSpec;
impl crate::RegisterSpec for Sgpio5cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio5c::R`](R) reader structure"]
impl crate::Readable for Sgpio5cSpec {}
#[doc = "`write(|w| ..)` method takes [`sgpio5c::W`](W) writer structure"]
impl crate::Writable for Sgpio5cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO5C to value 0"]
impl crate::Resettable for Sgpio5cSpec {}
