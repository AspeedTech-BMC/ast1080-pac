#[doc = "Register `SGPIO20` reader"]
pub type R = crate::R<Sgpio20Spec>;
#[doc = "Register `SGPIO20` writer"]
pub type W = crate::W<Sgpio20Spec>;
...
impl W {
    #[doc = "Bit 0 - Enable SGPIO bit 0~7 as 80h output"]
    #[inline(always)]
    pub fn enbl_sgpiobit07as80h_output(&mut self) -> EnblSgpiobit07as80hOutputW<Sgpio20Spec> {
        EnblSgpiobit07as80hOutputW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable SGPIO bit 8~15 as 80h output"]
    #[inline(always)]
    pub fn enbl_sgpiobit815as80h_output(&mut self) -> EnblSgpiobit815as80hOutputW<Sgpio20Spec> {
        EnblSgpiobit815as80hOutputW::new(self, 1)
    }
}
#[doc = "80h Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio20::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio20::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio20Spec;
impl crate::RegisterSpec for Sgpio20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio20::R`](R) reader structure"]
impl crate::Readable for Sgpio20Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio20::W`](W) writer structure"]
impl crate::Writable for Sgpio20Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO20 to value 0"]
impl crate::Resettable for Sgpio20Spec {}
