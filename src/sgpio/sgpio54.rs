#[doc = "Register `SGPIO54` reader"]
pub type R = crate::R<Sgpio54Spec>;
#[doc = "Register `SGPIO54` writer"]
pub type W = crate::W<Sgpio54Spec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#5\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio54::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio54::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio54Spec;
impl crate::RegisterSpec for Sgpio54Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio54::R`](R) reader structure"]
impl crate::Readable for Sgpio54Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio54::W`](W) writer structure"]
impl crate::Writable for Sgpio54Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO54 to value 0"]
impl crate::Resettable for Sgpio54Spec {}
