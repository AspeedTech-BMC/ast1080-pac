#[doc = "Register `SGPIO34` reader"]
pub type R = crate::R<Sgpio34Spec>;
#[doc = "Register `SGPIO34` writer"]
pub type W = crate::W<Sgpio34Spec>;
...
impl W {}
#[doc = "Debug Serial Out Register \\#4\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio34::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio34::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio34Spec;
impl crate::RegisterSpec for Sgpio34Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio34::R`](R) reader structure"]
impl crate::Readable for Sgpio34Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio34::W`](W) writer structure"]
impl crate::Writable for Sgpio34Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO34 to value 0"]
impl crate::Resettable for Sgpio34Spec {}
