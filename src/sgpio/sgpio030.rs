#[doc = "Register `SGPIO030` reader"]
pub type R = crate::R<Sgpio030Spec>;
#[doc = "Register `SGPIO030` writer"]
pub type W = crate::W<Sgpio030Spec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#3\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio030::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio030::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio030Spec;
impl crate::RegisterSpec for Sgpio030Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio030::R`](R) reader structure"]
impl crate::Readable for Sgpio030Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio030::W`](W) writer structure"]
impl crate::Writable for Sgpio030Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO030 to value 0"]
impl crate::Resettable for Sgpio030Spec {}
