#[doc = "Register `SGPIOC` reader"]
pub type R = crate::R<SgpiocSpec>;
#[doc = "Register `SGPIOC` writer"]
pub type W = crate::W<SgpiocSpec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#7\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpioc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpioc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SgpiocSpec;
impl crate::RegisterSpec for SgpiocSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpioc::R`](R) reader structure"]
impl crate::Readable for SgpiocSpec {}
#[doc = "`write(|w| ..)` method takes [`sgpioc::W`](W) writer structure"]
impl crate::Writable for SgpiocSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIOC to value 0"]
impl crate::Resettable for SgpiocSpec {}
