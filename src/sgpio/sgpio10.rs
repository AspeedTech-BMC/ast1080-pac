#[doc = "Register `SGPIO10` reader"]
pub type R = crate::R<Sgpio10Spec>;
#[doc = "Register `SGPIO10` writer"]
pub type W = crate::W<Sgpio10Spec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#3\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio10Spec;
impl crate::RegisterSpec for Sgpio10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio10::R`](R) reader structure"]
impl crate::Readable for Sgpio10Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio10::W`](W) writer structure"]
impl crate::Writable for Sgpio10Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO10 to value 0"]
impl crate::Resettable for Sgpio10Spec {}
