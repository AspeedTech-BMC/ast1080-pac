#[doc = "Register `SGPIO050` reader"]
pub type R = crate::R<Sgpio050Spec>;
#[doc = "Register `SGPIO050` writer"]
pub type W = crate::W<Sgpio050Spec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#4\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio050::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio050::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio050Spec;
impl crate::RegisterSpec for Sgpio050Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio050::R`](R) reader structure"]
impl crate::Readable for Sgpio050Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio050::W`](W) writer structure"]
impl crate::Writable for Sgpio050Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO050 to value 0"]
impl crate::Resettable for Sgpio050Spec {}
