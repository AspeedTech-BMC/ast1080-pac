#[doc = "Register `SGPIO04` reader"]
pub type R = crate::R<Sgpio04Spec>;
#[doc = "Register `SGPIO04` writer"]
pub type W = crate::W<Sgpio04Spec>;
...
impl W {}
#[doc = "Debug Serial In Register \\#0\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio04::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio04::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio04Spec;
impl crate::RegisterSpec for Sgpio04Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio04::R`](R) reader structure"]
impl crate::Readable for Sgpio04Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio04::W`](W) writer structure"]
impl crate::Writable for Sgpio04Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO04 to value 0"]
impl crate::Resettable for Sgpio04Spec {}
