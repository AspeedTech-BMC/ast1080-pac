#[doc = "Register `SGPIO058` reader"]
pub type R = crate::R<Sgpio058Spec>;
#[doc = "Register `SGPIO058` writer"]
pub type W = crate::W<Sgpio058Spec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#6\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio058::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio058::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio058Spec;
impl crate::RegisterSpec for Sgpio058Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio058::R`](R) reader structure"]
impl crate::Readable for Sgpio058Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio058::W`](W) writer structure"]
impl crate::Writable for Sgpio058Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO058 to value 0"]
impl crate::Resettable for Sgpio058Spec {}
