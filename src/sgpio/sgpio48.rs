#[doc = "Register `SGPIO48` reader"]
pub type R = crate::R<Sgpio48Spec>;
#[doc = "Register `SGPIO48` writer"]
pub type W = crate::W<Sgpio48Spec>;
...
impl W {}
#[doc = "Interrupt Status Register \\#2\n\nYou can [`read`](crate::Reg::read) this register and get [`sgpio48::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sgpio48::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sgpio48Spec;
impl crate::RegisterSpec for Sgpio48Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sgpio48::R`](R) reader structure"]
impl crate::Readable for Sgpio48Spec {}
#[doc = "`write(|w| ..)` method takes [`sgpio48::W`](W) writer structure"]
impl crate::Writable for Sgpio48Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SGPIO48 to value 0"]
impl crate::Resettable for Sgpio48Spec {}
