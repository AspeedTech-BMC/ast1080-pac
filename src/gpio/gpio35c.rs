#[doc = "Register `GPIO35C` reader"]
pub type R = crate::R<Gpio35cSpec>;
#[doc = "Register `GPIO35C` writer"]
pub type W = crate::W<Gpio35cSpec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg7(&mut self) -> DataReg7W<Gpio35cSpec> {
        DataReg7W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg7(&mut self) -> DirectionReg7W<Gpio35cSpec> {
        DirectionReg7W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl7(&mut self) -> Intenbl7W<Gpio35cSpec> {
        Intenbl7W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel7(&mut self) -> IntsensitivityType0sel7W<Gpio35cSpec> {
        IntsensitivityType0sel7W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel7(&mut self) -> IntsensitivityType1sel7W<Gpio35cSpec> {
        IntsensitivityType1sel7W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel7(&mut self) -> IntsensitivityType2sel7W<Gpio35cSpec> {
        IntsensitivityType2sel7W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl7(&mut self) -> RstToleranceEnbl7W<Gpio35cSpec> {
        RstToleranceEnbl7W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg17(&mut self) -> DebounceSettingReg17W<Gpio35cSpec> {
        DebounceSettingReg17W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg27(&mut self) -> DebounceSettingReg27W<Gpio35cSpec> {
        DebounceSettingReg27W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask7(&mut self) -> InputMask7W<Gpio35cSpec> {
        InputMask7W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel17(&mut self) -> BlinkCounterSel17W<Gpio35cSpec> {
        BlinkCounterSel17W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel27(&mut self) -> BlinkCounterSel27W<Gpio35cSpec> {
        BlinkCounterSel27W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg7(&mut self) -> IntstsReg7W<Gpio35cSpec> {
        IntstsReg7W::new(self, 12)
    }
}
#[doc = "GPIO119 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio35c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio35c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio35cSpec;
impl crate::RegisterSpec for Gpio35cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio35c::R`](R) reader structure"]
impl crate::Readable for Gpio35cSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio35c::W`](W) writer structure"]
impl crate::Writable for Gpio35cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO35C to value 0"]
impl crate::Resettable for Gpio35cSpec {}
