#[doc = "Register `GPIO230` reader"]
pub type R = crate::R<Gpio230Spec>;
#[doc = "Register `GPIO230` writer"]
pub type W = crate::W<Gpio230Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg4(&mut self) -> DataReg4W<Gpio230Spec> {
        DataReg4W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg4(&mut self) -> DirectionReg4W<Gpio230Spec> {
        DirectionReg4W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl4(&mut self) -> Intenbl4W<Gpio230Spec> {
        Intenbl4W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel4(&mut self) -> IntsensitivityType0sel4W<Gpio230Spec> {
        IntsensitivityType0sel4W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel4(&mut self) -> IntsensitivityType1sel4W<Gpio230Spec> {
        IntsensitivityType1sel4W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel4(&mut self) -> IntsensitivityType2sel4W<Gpio230Spec> {
        IntsensitivityType2sel4W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl4(&mut self) -> RstToleranceEnbl4W<Gpio230Spec> {
        RstToleranceEnbl4W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg14(&mut self) -> DebounceSettingReg14W<Gpio230Spec> {
        DebounceSettingReg14W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg24(&mut self) -> DebounceSettingReg24W<Gpio230Spec> {
        DebounceSettingReg24W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask4(&mut self) -> InputMask4W<Gpio230Spec> {
        InputMask4W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel14(&mut self) -> BlinkCounterSel14W<Gpio230Spec> {
        BlinkCounterSel14W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel24(&mut self) -> BlinkCounterSel24W<Gpio230Spec> {
        BlinkCounterSel24W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg4(&mut self) -> IntstsReg4W<Gpio230Spec> {
        IntstsReg4W::new(self, 12)
    }
}
#[doc = "GPIO044 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio230::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio230::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio230Spec;
impl crate::RegisterSpec for Gpio230Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio230::R`](R) reader structure"]
impl crate::Readable for Gpio230Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio230::W`](W) writer structure"]
impl crate::Writable for Gpio230Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO230 to value 0"]
impl crate::Resettable for Gpio230Spec {}
