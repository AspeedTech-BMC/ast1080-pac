#[doc = "Register `GPIO460` reader"]
pub type R = crate::R<Gpio460Spec>;
#[doc = "Register `GPIO460` writer"]
pub type W = crate::W<Gpio460Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg(&mut self) -> DataRegW<Gpio460Spec> {
        DataRegW::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg(&mut self) -> DirectionRegW<Gpio460Spec> {
        DirectionRegW::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl(&mut self) -> IntenblW<Gpio460Spec> {
        IntenblW::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel(&mut self) -> IntsensitivityType0selW<Gpio460Spec> {
        IntsensitivityType0selW::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel(&mut self) -> IntsensitivityType1selW<Gpio460Spec> {
        IntsensitivityType1selW::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel(&mut self) -> IntsensitivityType2selW<Gpio460Spec> {
        IntsensitivityType2selW::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl(&mut self) -> RstToleranceEnblW<Gpio460Spec> {
        RstToleranceEnblW::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg1(&mut self) -> DebounceSettingReg1W<Gpio460Spec> {
        DebounceSettingReg1W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg2(&mut self) -> DebounceSettingReg2W<Gpio460Spec> {
        DebounceSettingReg2W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask(&mut self) -> InputMaskW<Gpio460Spec> {
        InputMaskW::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel1(&mut self) -> BlinkCounterSel1W<Gpio460Spec> {
        BlinkCounterSel1W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel2(&mut self) -> BlinkCounterSel2W<Gpio460Spec> {
        BlinkCounterSel2W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg(&mut self) -> IntstsRegW<Gpio460Spec> {
        IntstsRegW::new(self, 12)
    }
}
#[doc = "GPIO184 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio460::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio460::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio460Spec;
impl crate::RegisterSpec for Gpio460Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio460::R`](R) reader structure"]
impl crate::Readable for Gpio460Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio460::W`](W) writer structure"]
impl crate::Writable for Gpio460Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO460 to value 0"]
impl crate::Resettable for Gpio460Spec {}
