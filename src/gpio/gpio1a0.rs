#[doc = "Register `GPIO1A0` reader"]
pub type R = crate::R<Gpio1a0Spec>;
#[doc = "Register `GPIO1A0` writer"]
pub type W = crate::W<Gpio1a0Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg(&mut self) -> DataRegW<Gpio1a0Spec> {
        DataRegW::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg(&mut self) -> DirectionRegW<Gpio1a0Spec> {
        DirectionRegW::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl(&mut self) -> IntenblW<Gpio1a0Spec> {
        IntenblW::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel(&mut self) -> IntsensitivityType0selW<Gpio1a0Spec> {
        IntsensitivityType0selW::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel(&mut self) -> IntsensitivityType1selW<Gpio1a0Spec> {
        IntsensitivityType1selW::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel(&mut self) -> IntsensitivityType2selW<Gpio1a0Spec> {
        IntsensitivityType2selW::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl(&mut self) -> RstToleranceEnblW<Gpio1a0Spec> {
        RstToleranceEnblW::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg1(&mut self) -> DebounceSettingReg1W<Gpio1a0Spec> {
        DebounceSettingReg1W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg2(&mut self) -> DebounceSettingReg2W<Gpio1a0Spec> {
        DebounceSettingReg2W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask(&mut self) -> InputMaskW<Gpio1a0Spec> {
        InputMaskW::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel1(&mut self) -> BlinkCounterSel1W<Gpio1a0Spec> {
        BlinkCounterSel1W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel2(&mut self) -> BlinkCounterSel2W<Gpio1a0Spec> {
        BlinkCounterSel2W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg(&mut self) -> IntstsRegW<Gpio1a0Spec> {
        IntstsRegW::new(self, 12)
    }
}
#[doc = "GPIO008 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio1a0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio1a0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio1a0Spec;
impl crate::RegisterSpec for Gpio1a0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio1a0::R`](R) reader structure"]
impl crate::Readable for Gpio1a0Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio1a0::W`](W) writer structure"]
impl crate::Writable for Gpio1a0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO1A0 to value 0"]
impl crate::Resettable for Gpio1a0Spec {}
