#[doc = "Register `GPIO32C` reader"]
pub type R = crate::R<Gpio32cSpec>;
#[doc = "Register `GPIO32C` writer"]
pub type W = crate::W<Gpio32cSpec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg3(&mut self) -> DataReg3W<Gpio32cSpec> {
        DataReg3W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg3(&mut self) -> DirectionReg3W<Gpio32cSpec> {
        DirectionReg3W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl3(&mut self) -> Intenbl3W<Gpio32cSpec> {
        Intenbl3W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel3(&mut self) -> IntsensitivityType0sel3W<Gpio32cSpec> {
        IntsensitivityType0sel3W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel3(&mut self) -> IntsensitivityType1sel3W<Gpio32cSpec> {
        IntsensitivityType1sel3W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel3(&mut self) -> IntsensitivityType2sel3W<Gpio32cSpec> {
        IntsensitivityType2sel3W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl3(&mut self) -> RstToleranceEnbl3W<Gpio32cSpec> {
        RstToleranceEnbl3W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg13(&mut self) -> DebounceSettingReg13W<Gpio32cSpec> {
        DebounceSettingReg13W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg23(&mut self) -> DebounceSettingReg23W<Gpio32cSpec> {
        DebounceSettingReg23W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask3(&mut self) -> InputMask3W<Gpio32cSpec> {
        InputMask3W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel13(&mut self) -> BlinkCounterSel13W<Gpio32cSpec> {
        BlinkCounterSel13W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel23(&mut self) -> BlinkCounterSel23W<Gpio32cSpec> {
        BlinkCounterSel23W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg3(&mut self) -> IntstsReg3W<Gpio32cSpec> {
        IntstsReg3W::new(self, 12)
    }
}
#[doc = "GPIO107 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio32c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio32c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio32cSpec;
impl crate::RegisterSpec for Gpio32cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio32c::R`](R) reader structure"]
impl crate::Readable for Gpio32cSpec {}
#[doc = "`write(|w| ..)` method takes [`gpio32c::W`](W) writer structure"]
impl crate::Writable for Gpio32cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO32C to value 0"]
impl crate::Resettable for Gpio32cSpec {}
