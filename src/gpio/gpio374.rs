#[doc = "Register `GPIO374` reader"]
pub type R = crate::R<Gpio374Spec>;
#[doc = "Register `GPIO374` writer"]
pub type W = crate::W<Gpio374Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg5(&mut self) -> DataReg5W<Gpio374Spec> {
        DataReg5W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg5(&mut self) -> DirectionReg5W<Gpio374Spec> {
        DirectionReg5W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl5(&mut self) -> Intenbl5W<Gpio374Spec> {
        Intenbl5W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel5(&mut self) -> IntsensitivityType0sel5W<Gpio374Spec> {
        IntsensitivityType0sel5W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel5(&mut self) -> IntsensitivityType1sel5W<Gpio374Spec> {
        IntsensitivityType1sel5W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel5(&mut self) -> IntsensitivityType2sel5W<Gpio374Spec> {
        IntsensitivityType2sel5W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl5(&mut self) -> RstToleranceEnbl5W<Gpio374Spec> {
        RstToleranceEnbl5W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg15(&mut self) -> DebounceSettingReg15W<Gpio374Spec> {
        DebounceSettingReg15W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg25(&mut self) -> DebounceSettingReg25W<Gpio374Spec> {
        DebounceSettingReg25W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask5(&mut self) -> InputMask5W<Gpio374Spec> {
        InputMask5W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel15(&mut self) -> BlinkCounterSel15W<Gpio374Spec> {
        BlinkCounterSel15W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel25(&mut self) -> BlinkCounterSel25W<Gpio374Spec> {
        BlinkCounterSel25W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg5(&mut self) -> IntstsReg5W<Gpio374Spec> {
        IntstsReg5W::new(self, 12)
    }
}
#[doc = "GPIO125 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio374::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio374::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio374Spec;
impl crate::RegisterSpec for Gpio374Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio374::R`](R) reader structure"]
impl crate::Readable for Gpio374Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio374::W`](W) writer structure"]
impl crate::Writable for Gpio374Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO374 to value 0"]
impl crate::Resettable for Gpio374Spec {}
