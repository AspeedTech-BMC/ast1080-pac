#[doc = "Register `GPIO238` reader"]
pub type R = crate::R<Gpio238Spec>;
#[doc = "Register `GPIO238` writer"]
pub type W = crate::W<Gpio238Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg6(&mut self) -> DataReg6W<Gpio238Spec> {
        DataReg6W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg6(&mut self) -> DirectionReg6W<Gpio238Spec> {
        DirectionReg6W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl6(&mut self) -> Intenbl6W<Gpio238Spec> {
        Intenbl6W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel6(&mut self) -> IntsensitivityType0sel6W<Gpio238Spec> {
        IntsensitivityType0sel6W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel6(&mut self) -> IntsensitivityType1sel6W<Gpio238Spec> {
        IntsensitivityType1sel6W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel6(&mut self) -> IntsensitivityType2sel6W<Gpio238Spec> {
        IntsensitivityType2sel6W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl6(&mut self) -> RstToleranceEnbl6W<Gpio238Spec> {
        RstToleranceEnbl6W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg16(&mut self) -> DebounceSettingReg16W<Gpio238Spec> {
        DebounceSettingReg16W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg26(&mut self) -> DebounceSettingReg26W<Gpio238Spec> {
        DebounceSettingReg26W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask6(&mut self) -> InputMask6W<Gpio238Spec> {
        InputMask6W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel16(&mut self) -> BlinkCounterSel16W<Gpio238Spec> {
        BlinkCounterSel16W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel26(&mut self) -> BlinkCounterSel26W<Gpio238Spec> {
        BlinkCounterSel26W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg6(&mut self) -> IntstsReg6W<Gpio238Spec> {
        IntstsReg6W::new(self, 12)
    }
}
#[doc = "GPIO046 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio238::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio238::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio238Spec;
impl crate::RegisterSpec for Gpio238Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio238::R`](R) reader structure"]
impl crate::Readable for Gpio238Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio238::W`](W) writer structure"]
impl crate::Writable for Gpio238Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO238 to value 0"]
impl crate::Resettable for Gpio238Spec {}
