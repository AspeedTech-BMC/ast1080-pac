#[doc = "Register `GPIO330` reader"]
pub type R = crate::R<Gpio330Spec>;
#[doc = "Register `GPIO330` writer"]
pub type W = crate::W<Gpio330Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg4(&mut self) -> DataReg4W<Gpio330Spec> {
        DataReg4W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg4(&mut self) -> DirectionReg4W<Gpio330Spec> {
        DirectionReg4W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl4(&mut self) -> Intenbl4W<Gpio330Spec> {
        Intenbl4W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel4(&mut self) -> IntsensitivityType0sel4W<Gpio330Spec> {
        IntsensitivityType0sel4W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel4(&mut self) -> IntsensitivityType1sel4W<Gpio330Spec> {
        IntsensitivityType1sel4W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel4(&mut self) -> IntsensitivityType2sel4W<Gpio330Spec> {
        IntsensitivityType2sel4W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl4(&mut self) -> RstToleranceEnbl4W<Gpio330Spec> {
        RstToleranceEnbl4W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg14(&mut self) -> DebounceSettingReg14W<Gpio330Spec> {
        DebounceSettingReg14W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg24(&mut self) -> DebounceSettingReg24W<Gpio330Spec> {
        DebounceSettingReg24W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask4(&mut self) -> InputMask4W<Gpio330Spec> {
        InputMask4W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel14(&mut self) -> BlinkCounterSel14W<Gpio330Spec> {
        BlinkCounterSel14W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel24(&mut self) -> BlinkCounterSel24W<Gpio330Spec> {
        BlinkCounterSel24W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg4(&mut self) -> IntstsReg4W<Gpio330Spec> {
        IntstsReg4W::new(self, 12)
    }
}
#[doc = "GPIO108 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio330::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio330::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio330Spec;
impl crate::RegisterSpec for Gpio330Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio330::R`](R) reader structure"]
impl crate::Readable for Gpio330Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio330::W`](W) writer structure"]
impl crate::Writable for Gpio330Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO330 to value 0"]
impl crate::Resettable for Gpio330Spec {}
