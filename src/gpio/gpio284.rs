#[doc = "Register `GPIO284` reader"]
pub type R = crate::R<Gpio284Spec>;
#[doc = "Register `GPIO284` writer"]
pub type W = crate::W<Gpio284Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg1(&mut self) -> DataReg1W<Gpio284Spec> {
        DataReg1W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg1(&mut self) -> DirectionReg1W<Gpio284Spec> {
        DirectionReg1W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl1(&mut self) -> Intenbl1W<Gpio284Spec> {
        Intenbl1W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel1(&mut self) -> IntsensitivityType0sel1W<Gpio284Spec> {
        IntsensitivityType0sel1W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel1(&mut self) -> IntsensitivityType1sel1W<Gpio284Spec> {
        IntsensitivityType1sel1W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel1(&mut self) -> IntsensitivityType2sel1W<Gpio284Spec> {
        IntsensitivityType2sel1W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl1(&mut self) -> RstToleranceEnbl1W<Gpio284Spec> {
        RstToleranceEnbl1W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg11(&mut self) -> DebounceSettingReg11W<Gpio284Spec> {
        DebounceSettingReg11W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg21(&mut self) -> DebounceSettingReg21W<Gpio284Spec> {
        DebounceSettingReg21W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask1(&mut self) -> InputMask1W<Gpio284Spec> {
        InputMask1W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel11(&mut self) -> BlinkCounterSel11W<Gpio284Spec> {
        BlinkCounterSel11W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel21(&mut self) -> BlinkCounterSel21W<Gpio284Spec> {
        BlinkCounterSel21W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg1(&mut self) -> IntstsReg1W<Gpio284Spec> {
        IntstsReg1W::new(self, 12)
    }
}
#[doc = "GPIO065 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio284::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio284::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio284Spec;
impl crate::RegisterSpec for Gpio284Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio284::R`](R) reader structure"]
impl crate::Readable for Gpio284Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio284::W`](W) writer structure"]
impl crate::Writable for Gpio284Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO284 to value 0"]
impl crate::Resettable for Gpio284Spec {}
