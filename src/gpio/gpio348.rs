#[doc = "Register `GPIO348` reader"]
pub type R = crate::R<Gpio348Spec>;
#[doc = "Register `GPIO348` writer"]
pub type W = crate::W<Gpio348Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg2(&mut self) -> DataReg2W<Gpio348Spec> {
        DataReg2W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg2(&mut self) -> DirectionReg2W<Gpio348Spec> {
        DirectionReg2W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl2(&mut self) -> Intenbl2W<Gpio348Spec> {
        Intenbl2W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel2(&mut self) -> IntsensitivityType0sel2W<Gpio348Spec> {
        IntsensitivityType0sel2W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel2(&mut self) -> IntsensitivityType1sel2W<Gpio348Spec> {
        IntsensitivityType1sel2W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel2(&mut self) -> IntsensitivityType2sel2W<Gpio348Spec> {
        IntsensitivityType2sel2W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl2(&mut self) -> RstToleranceEnbl2W<Gpio348Spec> {
        RstToleranceEnbl2W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg12(&mut self) -> DebounceSettingReg12W<Gpio348Spec> {
        DebounceSettingReg12W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg22(&mut self) -> DebounceSettingReg22W<Gpio348Spec> {
        DebounceSettingReg22W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask2(&mut self) -> InputMask2W<Gpio348Spec> {
        InputMask2W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel12(&mut self) -> BlinkCounterSel12W<Gpio348Spec> {
        BlinkCounterSel12W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel22(&mut self) -> BlinkCounterSel22W<Gpio348Spec> {
        BlinkCounterSel22W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg2(&mut self) -> IntstsReg2W<Gpio348Spec> {
        IntstsReg2W::new(self, 12)
    }
}
#[doc = "GPIO114 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio348::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio348::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio348Spec;
impl crate::RegisterSpec for Gpio348Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio348::R`](R) reader structure"]
impl crate::Readable for Gpio348Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio348::W`](W) writer structure"]
impl crate::Writable for Gpio348Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO348 to value 0"]
impl crate::Resettable for Gpio348Spec {}
