#[doc = "Register `GPIO1F8` reader"]
pub type R = crate::R<Gpio1f8Spec>;
#[doc = "Register `GPIO1F8` writer"]
pub type W = crate::W<Gpio1f8Spec>;
#[doc = "Data register\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Data register"]
    #[inline(always)]
    pub fn data_reg6(&mut self) -> DataReg6W<Gpio1f8Spec> {
        DataReg6W::new(self, 0)
    }
    #[doc = "Bit 1 - Direction register"]
    #[inline(always)]
    pub fn direction_reg6(&mut self) -> DirectionReg6W<Gpio1f8Spec> {
        DirectionReg6W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt enable"]
    #[inline(always)]
    pub fn intenbl6(&mut self) -> Intenbl6W<Gpio1f8Spec> {
        Intenbl6W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt sensitivity type 0 selection"]
    #[inline(always)]
    pub fn intsensitivity_type0sel6(&mut self) -> IntsensitivityType0sel6W<Gpio1f8Spec> {
        IntsensitivityType0sel6W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt sensitivity type 1 selection"]
    #[inline(always)]
    pub fn intsensitivity_type1sel6(&mut self) -> IntsensitivityType1sel6W<Gpio1f8Spec> {
        IntsensitivityType1sel6W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt sensitivity type 2 selection"]
    #[inline(always)]
    pub fn intsensitivity_type2sel6(&mut self) -> IntsensitivityType2sel6W<Gpio1f8Spec> {
        IntsensitivityType2sel6W::new(self, 5)
    }
    #[doc = "Bit 6 - Reset tolerance enable"]
    #[inline(always)]
    pub fn rst_tolerance_enbl6(&mut self) -> RstToleranceEnbl6W<Gpio1f8Spec> {
        RstToleranceEnbl6W::new(self, 6)
    }
    #[doc = "Bit 7 - Debounce setting register #1"]
    #[inline(always)]
    pub fn debounce_setting_reg16(&mut self) -> DebounceSettingReg16W<Gpio1f8Spec> {
        DebounceSettingReg16W::new(self, 7)
    }
    #[doc = "Bit 8 - Debounce setting register #2"]
    #[inline(always)]
    pub fn debounce_setting_reg26(&mut self) -> DebounceSettingReg26W<Gpio1f8Spec> {
        DebounceSettingReg26W::new(self, 8)
    }
    #[doc = "Bit 9 - Input mask"]
    #[inline(always)]
    pub fn input_mask6(&mut self) -> InputMask6W<Gpio1f8Spec> {
        InputMask6W::new(self, 9)
    }
    #[doc = "Bit 10 - Blink Counter Selection #1"]
    #[inline(always)]
    pub fn blink_counter_sel16(&mut self) -> BlinkCounterSel16W<Gpio1f8Spec> {
        BlinkCounterSel16W::new(self, 10)
    }
    #[doc = "Bit 11 - Blink Counter Selection #2"]
    #[inline(always)]
    pub fn blink_counter_sel26(&mut self) -> BlinkCounterSel26W<Gpio1f8Spec> {
        BlinkCounterSel26W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt status register"]
    #[inline(always)]
    pub fn intsts_reg6(&mut self) -> IntstsReg6W<Gpio1f8Spec> {
        IntstsReg6W::new(self, 12)
    }
}
#[doc = "GPIO030 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio1f8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio1f8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Gpio1f8Spec;
impl crate::RegisterSpec for Gpio1f8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio1f8::R`](R) reader structure"]
impl crate::Readable for Gpio1f8Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio1f8::W`](W) writer structure"]
impl crate::Writable for Gpio1f8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO1F8 to value 0"]
impl crate::Resettable for Gpio1f8Spec {}
