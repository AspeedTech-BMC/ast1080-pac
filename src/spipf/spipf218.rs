...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid3(&mut self) -> RegionValid3W<Spipf218Spec> {
        RegionValid3W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region3(&mut self) -> DisWrToThisRegion3W<Spipf218Spec> {
        DisWrToThisRegion3W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region3(&mut self) -> DisReadToThisRegion3W<Spipf218Spec> {
        DisReadToThisRegion3W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start3(&mut self) -> RegionStart3W<Spipf218Spec> {
        RegionStart3W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size3(&mut self) -> RegionSize3W<Spipf218Spec> {
        RegionSize3W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot3(&mut self) -> WrProt3W<Spipf218Spec> {
