...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid(&mut self) -> RegionValidW<Spipf100Spec> {
        RegionValidW::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region(&mut self) -> DisWrToThisRegionW<Spipf100Spec> {
        DisWrToThisRegionW::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region(&mut self) -> DisReadToThisRegionW<Spipf100Spec> {
        DisReadToThisRegionW::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start(&mut self) -> RegionStartW<Spipf100Spec> {
        RegionStartW::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size(&mut self) -> RegionSizeW<Spipf100Spec> {
        RegionSizeW::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot(&mut self) -> WrProtW<Spipf100Spec> {
        WrProtW::new(self, 63)
    }
}
