...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid11(&mut self) -> RegionValid11W<Spipf258Spec> {
        RegionValid11W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region11(&mut self) -> DisWrToThisRegion11W<Spipf258Spec> {
        DisWrToThisRegion11W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region11(&mut self) -> DisReadToThisRegion11W<Spipf258Spec> {
        DisReadToThisRegion11W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start11(&mut self) -> RegionStart11W<Spipf258Spec> {
        RegionStart11W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size11(&mut self) -> RegionSize11W<Spipf258Spec> {
        RegionSize11W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot11(&mut self) -> WrProt11W<Spipf258Spec> {
