...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid6(&mut self) -> RegionValid6W<Spipf130Spec> {
        RegionValid6W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region6(&mut self) -> DisWrToThisRegion6W<Spipf130Spec> {
        DisWrToThisRegion6W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region6(&mut self) -> DisReadToThisRegion6W<Spipf130Spec> {
        DisReadToThisRegion6W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start6(&mut self) -> RegionStart6W<Spipf130Spec> {
        RegionStart6W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size6(&mut self) -> RegionSize6W<Spipf130Spec> {
        RegionSize6W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot6(&mut self) -> WrProt6W<Spipf130Spec> {
