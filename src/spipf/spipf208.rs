...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid1(&mut self) -> RegionValid1W<Spipf208Spec> {
        RegionValid1W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region1(&mut self) -> DisWrToThisRegion1W<Spipf208Spec> {
        DisWrToThisRegion1W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region1(&mut self) -> DisReadToThisRegion1W<Spipf208Spec> {
        DisReadToThisRegion1W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start1(&mut self) -> RegionStart1W<Spipf208Spec> {
        RegionStart1W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size1(&mut self) -> RegionSize1W<Spipf208Spec> {
        RegionSize1W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot1(&mut self) -> WrProt1W<Spipf208Spec> {
