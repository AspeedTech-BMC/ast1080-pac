...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid9(&mut self) -> RegionValid9W<Spipf2c8Spec> {
        RegionValid9W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region9(&mut self) -> DisWrToThisRegion9W<Spipf2c8Spec> {
        DisWrToThisRegion9W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region9(&mut self) -> DisReadToThisRegion9W<Spipf2c8Spec> {
        DisReadToThisRegion9W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start9(&mut self) -> RegionStart9W<Spipf2c8Spec> {
        RegionStart9W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size9(&mut self) -> RegionSize9W<Spipf2c8Spec> {
        RegionSize9W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot9(&mut self) -> WrProt9W<Spipf2c8Spec> {
