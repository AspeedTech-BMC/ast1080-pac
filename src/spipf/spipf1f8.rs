...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid15(&mut self) -> RegionValid15W<Spipf1f8Spec> {
        RegionValid15W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region15(&mut self) -> DisWrToThisRegion15W<Spipf1f8Spec> {
        DisWrToThisRegion15W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region15(&mut self) -> DisReadToThisRegion15W<Spipf1f8Spec> {
        DisReadToThisRegion15W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start15(&mut self) -> RegionStart15W<Spipf1f8Spec> {
        RegionStart15W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size15(&mut self) -> RegionSize15W<Spipf1f8Spec> {
        RegionSize15W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot15(&mut self) -> WrProt15W<Spipf1f8Spec> {
