...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid4(&mut self) -> RegionValid4W<Spipf220Spec> {
        RegionValid4W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region4(&mut self) -> DisWrToThisRegion4W<Spipf220Spec> {
        DisWrToThisRegion4W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region4(&mut self) -> DisReadToThisRegion4W<Spipf220Spec> {
        DisReadToThisRegion4W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start4(&mut self) -> RegionStart4W<Spipf220Spec> {
        RegionStart4W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size4(&mut self) -> RegionSize4W<Spipf220Spec> {
        RegionSize4W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot4(&mut self) -> WrProt4W<Spipf220Spec> {
