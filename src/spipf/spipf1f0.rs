...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid14(&mut self) -> RegionValid14W<Spipf1f0Spec> {
        RegionValid14W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region14(&mut self) -> DisWrToThisRegion14W<Spipf1f0Spec> {
        DisWrToThisRegion14W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region14(&mut self) -> DisReadToThisRegion14W<Spipf1f0Spec> {
        DisReadToThisRegion14W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start14(&mut self) -> RegionStart14W<Spipf1f0Spec> {
        RegionStart14W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size14(&mut self) -> RegionSize14W<Spipf1f0Spec> {
        RegionSize14W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot14(&mut self) -> WrProt14W<Spipf1f0Spec> {
