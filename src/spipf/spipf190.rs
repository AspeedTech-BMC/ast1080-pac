...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid2(&mut self) -> RegionValid2W<Spipf190Spec> {
        RegionValid2W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region2(&mut self) -> DisWrToThisRegion2W<Spipf190Spec> {
        DisWrToThisRegion2W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region2(&mut self) -> DisReadToThisRegion2W<Spipf190Spec> {
        DisReadToThisRegion2W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start2(&mut self) -> RegionStart2W<Spipf190Spec> {
        RegionStart2W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size2(&mut self) -> RegionSize2W<Spipf190Spec> {
        RegionSize2W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot2(&mut self) -> WrProt2W<Spipf190Spec> {
