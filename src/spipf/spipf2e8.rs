...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid13(&mut self) -> RegionValid13W<Spipf2e8Spec> {
        RegionValid13W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region13(&mut self) -> DisWrToThisRegion13W<Spipf2e8Spec> {
        DisWrToThisRegion13W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region13(&mut self) -> DisReadToThisRegion13W<Spipf2e8Spec> {
        DisReadToThisRegion13W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start13(&mut self) -> RegionStart13W<Spipf2e8Spec> {
        RegionStart13W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size13(&mut self) -> RegionSize13W<Spipf2e8Spec> {
        RegionSize13W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot13(&mut self) -> WrProt13W<Spipf2e8Spec> {
