...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid12(&mut self) -> RegionValid12W<Spipf2e0Spec> {
        RegionValid12W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region12(&mut self) -> DisWrToThisRegion12W<Spipf2e0Spec> {
        DisWrToThisRegion12W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region12(&mut self) -> DisReadToThisRegion12W<Spipf2e0Spec> {
        DisReadToThisRegion12W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start12(&mut self) -> RegionStart12W<Spipf2e0Spec> {
        RegionStart12W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size12(&mut self) -> RegionSize12W<Spipf2e0Spec> {
        RegionSize12W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot12(&mut self) -> WrProt12W<Spipf2e0Spec> {
