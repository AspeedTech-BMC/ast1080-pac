...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid7(&mut self) -> RegionValid7W<Spipf138Spec> {
        RegionValid7W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region7(&mut self) -> DisWrToThisRegion7W<Spipf138Spec> {
        DisWrToThisRegion7W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region7(&mut self) -> DisReadToThisRegion7W<Spipf138Spec> {
        DisReadToThisRegion7W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start7(&mut self) -> RegionStart7W<Spipf138Spec> {
        RegionStart7W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size7(&mut self) -> RegionSize7W<Spipf138Spec> {
        RegionSize7W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot7(&mut self) -> WrProt7W<Spipf138Spec> {
