...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid10(&mut self) -> RegionValid10W<Spipf250Spec> {
        RegionValid10W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region10(&mut self) -> DisWrToThisRegion10W<Spipf250Spec> {
        DisWrToThisRegion10W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region10(&mut self) -> DisReadToThisRegion10W<Spipf250Spec> {
        DisReadToThisRegion10W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start10(&mut self) -> RegionStart10W<Spipf250Spec> {
        RegionStart10W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size10(&mut self) -> RegionSize10W<Spipf250Spec> {
        RegionSize10W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot10(&mut self) -> WrProt10W<Spipf250Spec> {
