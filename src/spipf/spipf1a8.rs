...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid5(&mut self) -> RegionValid5W<Spipf1a8Spec> {
        RegionValid5W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region5(&mut self) -> DisWrToThisRegion5W<Spipf1a8Spec> {
        DisWrToThisRegion5W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region5(&mut self) -> DisReadToThisRegion5W<Spipf1a8Spec> {
        DisReadToThisRegion5W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start5(&mut self) -> RegionStart5W<Spipf1a8Spec> {
        RegionStart5W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size5(&mut self) -> RegionSize5W<Spipf1a8Spec> {
        RegionSize5W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot5(&mut self) -> WrProt5W<Spipf1a8Spec> {
