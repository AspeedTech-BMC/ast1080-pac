...
impl W {
    #[doc = "Bit 0 - Region Valid"]
    #[inline(always)]
    pub fn region_valid8(&mut self) -> RegionValid8W<Spipf140Spec> {
        RegionValid8W::new(self, 0)
    }
    #[doc = "Bit 1 - Disable Write to this region"]
    #[inline(always)]
    pub fn dis_wr_to_this_region8(&mut self) -> DisWrToThisRegion8W<Spipf140Spec> {
        DisWrToThisRegion8W::new(self, 1)
    }
    #[doc = "Bit 2 - Disable Read to this region"]
    #[inline(always)]
    pub fn dis_read_to_this_region8(&mut self) -> DisReadToThisRegion8W<Spipf140Spec> {
        DisReadToThisRegion8W::new(self, 2)
    }
    #[doc = "Bits 12:31 - Region Start"]
    #[inline(always)]
    pub fn region_start8(&mut self) -> RegionStart8W<Spipf140Spec> {
        RegionStart8W::new(self, 12)
    }
    #[doc = "Bits 32:52 - Region Size"]
    #[inline(always)]
    pub fn region_size8(&mut self) -> RegionSize8W<Spipf140Spec> {
        RegionSize8W::new(self, 32)
    }
    #[doc = "Bit 63 - Write Protection"]
    #[inline(always)]
    pub fn wr_prot8(&mut self) -> WrProt8W<Spipf140Spec> {
