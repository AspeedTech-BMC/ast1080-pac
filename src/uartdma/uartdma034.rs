#[doc = "Register `UARTDMA034` reader"]
pub type R = crate::R<Uartdma034Spec>;
#[doc = "Register `UARTDMA034` writer"]
pub type W = crate::W<Uartdma034Spec>;
...
impl W {
    #[doc = "Bit 0 - UART0 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart0txdmaintsts(&mut self) -> Uart0txdmaintstsW<Uartdma034Spec> {
        Uart0txdmaintstsW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart1txdmaintsts(&mut self) -> Uart1txdmaintstsW<Uartdma034Spec> {
        Uart1txdmaintstsW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart2txdmaintsts(&mut self) -> Uart2txdmaintstsW<Uartdma034Spec> {
        Uart2txdmaintstsW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart3txdmaintsts(&mut self) -> Uart3txdmaintstsW<Uartdma034Spec> {
        Uart3txdmaintstsW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart5txdmaintsts(&mut self) -> Uart5txdmaintstsW<Uartdma034Spec> {
        Uart5txdmaintstsW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart6txdmaintsts(&mut self) -> Uart6txdmaintstsW<Uartdma034Spec> {
        Uart6txdmaintstsW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart7txdmaintsts(&mut self) -> Uart7txdmaintstsW<Uartdma034Spec> {
        Uart7txdmaintstsW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart8txdmaintsts(&mut self) -> Uart8txdmaintstsW<Uartdma034Spec> {
        Uart8txdmaintstsW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart9txdmaintsts(&mut self) -> Uart9txdmaintstsW<Uartdma034Spec> {
        Uart9txdmaintstsW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart10txdmaintsts(&mut self) -> Uart10txdmaintstsW<Uartdma034Spec> {
        Uart10txdmaintstsW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 TX DMA interrupt status"]
    #[inline(always)]
    pub fn uart11txdmaintsts(&mut self) -> Uart11txdmaintstsW<Uartdma034Spec> {
        Uart11txdmaintstsW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC TX DMA interrupt status"]
    #[inline(always)]
    pub fn uartbmctxdmaintsts(&mut self) -> UartbmctxdmaintstsW<Uartdma034Spec> {
        UartbmctxdmaintstsW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 TX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart0txdmaintsts(&mut self) -> Vuart0txdmaintstsW<Uartdma034Spec> {
        Vuart0txdmaintstsW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 TX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart1txdmaintsts(&mut self) -> Vuart1txdmaintstsW<Uartdma034Spec> {
        Vuart1txdmaintstsW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 TX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart2txdmaintsts(&mut self) -> Vuart2txdmaintstsW<Uartdma034Spec> {
        Vuart2txdmaintstsW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 TX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart3txdmaintsts(&mut self) -> Vuart3txdmaintstsW<Uartdma034Spec> {
        Vuart3txdmaintstsW::new(self, 15)
    }
}
#[doc = "UART TX DMA interrrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uartdma034::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uartdma034::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uartdma034Spec;
impl crate::RegisterSpec for Uartdma034Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uartdma034::R`](R) reader structure"]
impl crate::Readable for Uartdma034Spec {}
#[doc = "`write(|w| ..)` method takes [`uartdma034::W`](W) writer structure"]
impl crate::Writable for Uartdma034Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UARTDMA034 to value 0"]
impl crate::Resettable for Uartdma034Spec {}
