...
impl W {
    #[doc = "Bit 0 - UART0 TX DMA reset"]
    #[inline(always)]
    pub fn uart0txdmarst(&mut self) -> Uart0txdmarstW<Udma020Spec> {
        Uart0txdmarstW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 TX DMA reset"]
    #[inline(always)]
    pub fn uart1txdmarst(&mut self) -> Uart1txdmarstW<Udma020Spec> {
        Uart1txdmarstW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 TX DMA reset"]
    #[inline(always)]
    pub fn uart2txdmarst(&mut self) -> Uart2txdmarstW<Udma020Spec> {
        Uart2txdmarstW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 TX DMA reset"]
    #[inline(always)]
    pub fn uart3txdmarst(&mut self) -> Uart3txdmarstW<Udma020Spec> {
        Uart3txdmarstW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 TX DMA reset"]
    #[inline(always)]
    pub fn uart5txdmarst(&mut self) -> Uart5txdmarstW<Udma020Spec> {
        Uart5txdmarstW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 TX DMA reset"]
    #[inline(always)]
    pub fn uart6txdmarst(&mut self) -> Uart6txdmarstW<Udma020Spec> {
        Uart6txdmarstW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 TX DMA reset"]
    #[inline(always)]
    pub fn uart7txdmarst(&mut self) -> Uart7txdmarstW<Udma020Spec> {
        Uart7txdmarstW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 TX DMA reset"]
    #[inline(always)]
    pub fn uart8txdmarst(&mut self) -> Uart8txdmarstW<Udma020Spec> {
        Uart8txdmarstW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 TX DMA reset"]
    #[inline(always)]
    pub fn uart9txdmarst(&mut self) -> Uart9txdmarstW<Udma020Spec> {
        Uart9txdmarstW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 TX DMA reset"]
    #[inline(always)]
    pub fn uart10txdmarst(&mut self) -> Uart10txdmarstW<Udma020Spec> {
        Uart10txdmarstW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 TX DMA reset"]
    #[inline(always)]
    pub fn uart11txdmarst(&mut self) -> Uart11txdmarstW<Udma020Spec> {
        Uart11txdmarstW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC TX DMA reset"]
    #[inline(always)]
    pub fn uartbmctxdmarst(&mut self) -> UartbmctxdmarstW<Udma020Spec> {
        UartbmctxdmarstW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 TX DMA reset"]
    #[inline(always)]
    pub fn vuart0txdmarst(&mut self) -> Vuart0txdmarstW<Udma020Spec> {
        Vuart0txdmarstW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 TX DMA reset"]
    #[inline(always)]
    pub fn vuart1txdmarst(&mut self) -> Vuart1txdmarstW<Udma020Spec> {
        Vuart1txdmarstW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 TX DMA reset"]
    #[inline(always)]
    pub fn vuart2txdmarst(&mut self) -> Vuart2txdmarstW<Udma020Spec> {
        Vuart2txdmarstW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 TX DMA reset"]
    #[inline(always)]
    pub fn vuart3txdmarst(&mut self) -> Vuart3txdmarstW<Udma020Spec> {
