...
impl W {
    #[doc = "Bit 0 - UART0 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart0rxdmaintsts(&mut self) -> Uart0rxdmaintstsW<Udma03cSpec> {
        Uart0rxdmaintstsW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart1rxdmaintsts(&mut self) -> Uart1rxdmaintstsW<Udma03cSpec> {
        Uart1rxdmaintstsW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart2rxdmaintsts(&mut self) -> Uart2rxdmaintstsW<Udma03cSpec> {
        Uart2rxdmaintstsW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart3rxdmaintsts(&mut self) -> Uart3rxdmaintstsW<Udma03cSpec> {
        Uart3rxdmaintstsW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart5rxdmaintsts(&mut self) -> Uart5rxdmaintstsW<Udma03cSpec> {
        Uart5rxdmaintstsW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart6rxdmaintsts(&mut self) -> Uart6rxdmaintstsW<Udma03cSpec> {
        Uart6rxdmaintstsW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart7rxdmaintsts(&mut self) -> Uart7rxdmaintstsW<Udma03cSpec> {
        Uart7rxdmaintstsW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart8rxdmaintsts(&mut self) -> Uart8rxdmaintstsW<Udma03cSpec> {
        Uart8rxdmaintstsW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart9rxdmaintsts(&mut self) -> Uart9rxdmaintstsW<Udma03cSpec> {
        Uart9rxdmaintstsW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart10rxdmaintsts(&mut self) -> Uart10rxdmaintstsW<Udma03cSpec> {
        Uart10rxdmaintstsW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 RX DMA interrupt status"]
    #[inline(always)]
    pub fn uart11rxdmaintsts(&mut self) -> Uart11rxdmaintstsW<Udma03cSpec> {
        Uart11rxdmaintstsW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC RX DMA interrupt status"]
    #[inline(always)]
    pub fn uartbmcrxdmaintsts(&mut self) -> UartbmcrxdmaintstsW<Udma03cSpec> {
        UartbmcrxdmaintstsW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 RX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart0rxdmaintsts(&mut self) -> Vuart0rxdmaintstsW<Udma03cSpec> {
        Vuart0rxdmaintstsW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 RX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart1rxdmaintsts(&mut self) -> Vuart1rxdmaintstsW<Udma03cSpec> {
        Vuart1rxdmaintstsW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 RX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart2rxdmaintsts(&mut self) -> Vuart2rxdmaintstsW<Udma03cSpec> {
        Vuart2rxdmaintstsW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 RX DMA interrupt status"]
    #[inline(always)]
    pub fn vuart3rxdmaintsts(&mut self) -> Vuart3rxdmaintstsW<Udma03cSpec> {
