#[doc = "Register `UARTDMA004` reader"]
pub type R = crate::R<Uartdma004Spec>;
#[doc = "Register `UARTDMA004` writer"]
pub type W = crate::W<Uartdma004Spec>;
...
impl W {
    #[doc = "Bit 0 - UART0 RX DMA enable register"]
    #[inline(always)]
    pub fn uart0rxdmaenbl_reg(&mut self) -> Uart0rxdmaenblRegW<Uartdma004Spec> {
        Uart0rxdmaenblRegW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 RX DMA enable register"]
    #[inline(always)]
    pub fn uart1rxdmaenbl_reg(&mut self) -> Uart1rxdmaenblRegW<Uartdma004Spec> {
        Uart1rxdmaenblRegW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 RX DMA enable register"]
    #[inline(always)]
    pub fn uart2rxdmaenbl_reg(&mut self) -> Uart2rxdmaenblRegW<Uartdma004Spec> {
        Uart2rxdmaenblRegW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 RX DMA enable register"]
    #[inline(always)]
    pub fn uart3rxdmaenbl_reg(&mut self) -> Uart3rxdmaenblRegW<Uartdma004Spec> {
        Uart3rxdmaenblRegW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 RX DMA enable register"]
    #[inline(always)]
    pub fn uart5rxdmaenbl_reg(&mut self) -> Uart5rxdmaenblRegW<Uartdma004Spec> {
        Uart5rxdmaenblRegW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 RX DMA enable register"]
    #[inline(always)]
    pub fn uart6rxdmaenbl_reg(&mut self) -> Uart6rxdmaenblRegW<Uartdma004Spec> {
        Uart6rxdmaenblRegW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 RX DMA enable register"]
    #[inline(always)]
    pub fn uart7rxdmaenbl_reg(&mut self) -> Uart7rxdmaenblRegW<Uartdma004Spec> {
        Uart7rxdmaenblRegW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 RX DMA enable register"]
    #[inline(always)]
    pub fn uart8rxdmaenbl_reg(&mut self) -> Uart8rxdmaenblRegW<Uartdma004Spec> {
        Uart8rxdmaenblRegW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 RX DMA enable register"]
    #[inline(always)]
    pub fn uart9rxdmaenbl_reg(&mut self) -> Uart9rxdmaenblRegW<Uartdma004Spec> {
        Uart9rxdmaenblRegW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 RX DMA enable register"]
    #[inline(always)]
    pub fn uart10rxdmaenbl_reg(&mut self) -> Uart10rxdmaenblRegW<Uartdma004Spec> {
        Uart10rxdmaenblRegW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 RX DMA enable register"]
    #[inline(always)]
    pub fn uart11rxdmaenbl_reg(&mut self) -> Uart11rxdmaenblRegW<Uartdma004Spec> {
        Uart11rxdmaenblRegW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC RX DMA enable register"]
    #[inline(always)]
    pub fn uartbmcrxdmaenbl_reg(&mut self) -> UartbmcrxdmaenblRegW<Uartdma004Spec> {
        UartbmcrxdmaenblRegW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 RX DMA enable register"]
    #[inline(always)]
    pub fn vuart0rxdmaenbl_reg(&mut self) -> Vuart0rxdmaenblRegW<Uartdma004Spec> {
        Vuart0rxdmaenblRegW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 RX DMA enable register"]
    #[inline(always)]
    pub fn vuart1rxdmaenbl_reg(&mut self) -> Vuart1rxdmaenblRegW<Uartdma004Spec> {
        Vuart1rxdmaenblRegW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 RX DMA enable register"]
    #[inline(always)]
    pub fn vuart2rxdmaenbl_reg(&mut self) -> Vuart2rxdmaenblRegW<Uartdma004Spec> {
        Vuart2rxdmaenblRegW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 RX DMA enable register"]
    #[inline(always)]
    pub fn vuart3rxdmaenbl_reg(&mut self) -> Vuart3rxdmaenblRegW<Uartdma004Spec> {
        Vuart3rxdmaenblRegW::new(self, 15)
    }
}
#[doc = "UART RX DMA enable\n\nYou can [`read`](crate::Reg::read) this register and get [`uartdma004::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uartdma004::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uartdma004Spec;
impl crate::RegisterSpec for Uartdma004Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uartdma004::R`](R) reader structure"]
impl crate::Readable for Uartdma004Spec {}
#[doc = "`write(|w| ..)` method takes [`uartdma004::W`](W) writer structure"]
impl crate::Writable for Uartdma004Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UARTDMA004 to value 0"]
impl crate::Resettable for Uartdma004Spec {}
