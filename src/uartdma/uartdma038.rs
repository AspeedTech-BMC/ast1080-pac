#[doc = "Register `UARTDMA038` reader"]
pub type R = crate::R<Uartdma038Spec>;
#[doc = "Register `UARTDMA038` writer"]
pub type W = crate::W<Uartdma038Spec>;
...
impl W {
    #[doc = "Bit 0 - UART0 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart0rxdmaintenbl(&mut self) -> Uart0rxdmaintenblW<Uartdma038Spec> {
        Uart0rxdmaintenblW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart1rxdmaintenbl(&mut self) -> Uart1rxdmaintenblW<Uartdma038Spec> {
        Uart1rxdmaintenblW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart2rxdmaintenbl(&mut self) -> Uart2rxdmaintenblW<Uartdma038Spec> {
        Uart2rxdmaintenblW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart3rxdmaintenbl(&mut self) -> Uart3rxdmaintenblW<Uartdma038Spec> {
        Uart3rxdmaintenblW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart5rxdmaintenbl(&mut self) -> Uart5rxdmaintenblW<Uartdma038Spec> {
        Uart5rxdmaintenblW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart6rxdmaintenbl(&mut self) -> Uart6rxdmaintenblW<Uartdma038Spec> {
        Uart6rxdmaintenblW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart7rxdmaintenbl(&mut self) -> Uart7rxdmaintenblW<Uartdma038Spec> {
        Uart7rxdmaintenblW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart8rxdmaintenbl(&mut self) -> Uart8rxdmaintenblW<Uartdma038Spec> {
        Uart8rxdmaintenblW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart9rxdmaintenbl(&mut self) -> Uart9rxdmaintenblW<Uartdma038Spec> {
        Uart9rxdmaintenblW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart10rxdmaintenbl(&mut self) -> Uart10rxdmaintenblW<Uartdma038Spec> {
        Uart10rxdmaintenblW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart11rxdmaintenbl(&mut self) -> Uart11rxdmaintenblW<Uartdma038Spec> {
        Uart11rxdmaintenblW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC RX DMA interrupt enable"]
    #[inline(always)]
    pub fn uartbmcrxdmaintenbl(&mut self) -> UartbmcrxdmaintenblW<Uartdma038Spec> {
        UartbmcrxdmaintenblW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart0rxdmaintenbl(&mut self) -> Vuart0rxdmaintenblW<Uartdma038Spec> {
        Vuart0rxdmaintenblW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart1rxdmaintenbl(&mut self) -> Vuart1rxdmaintenblW<Uartdma038Spec> {
        Vuart1rxdmaintenblW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart2rxdmaintenbl(&mut self) -> Vuart2rxdmaintenblW<Uartdma038Spec> {
        Vuart2rxdmaintenblW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 RX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart3rxdmaintenbl(&mut self) -> Vuart3rxdmaintenblW<Uartdma038Spec> {
        Vuart3rxdmaintenblW::new(self, 15)
    }
}
#[doc = "UART RX DMA interrrupt enable\n\nYou can [`read`](crate::Reg::read) this register and get [`uartdma038::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uartdma038::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uartdma038Spec;
impl crate::RegisterSpec for Uartdma038Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uartdma038::R`](R) reader structure"]
impl crate::Readable for Uartdma038Spec {}
#[doc = "`write(|w| ..)` method takes [`uartdma038::W`](W) writer structure"]
impl crate::Writable for Uartdma038Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UARTDMA038 to value 0"]
impl crate::Resettable for Uartdma038Spec {}
