#[doc = "Register `UARTDMA024` reader"]
pub type R = crate::R<Uartdma024Spec>;
#[doc = "Register `UARTDMA024` writer"]
pub type W = crate::W<Uartdma024Spec>;
...
impl W {
    #[doc = "Bit 0 - UART0 RX DMA reset"]
    #[inline(always)]
    pub fn uart0rxdmarst(&mut self) -> Uart0rxdmarstW<Uartdma024Spec> {
        Uart0rxdmarstW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 RX DMA reset"]
    #[inline(always)]
    pub fn uart1rxdmarst(&mut self) -> Uart1rxdmarstW<Uartdma024Spec> {
        Uart1rxdmarstW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 RX DMA reset"]
    #[inline(always)]
    pub fn uart2rxdmarst(&mut self) -> Uart2rxdmarstW<Uartdma024Spec> {
        Uart2rxdmarstW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 RX DMA reset"]
    #[inline(always)]
    pub fn uart3rxdmarst(&mut self) -> Uart3rxdmarstW<Uartdma024Spec> {
        Uart3rxdmarstW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 RX DMA reset"]
    #[inline(always)]
    pub fn uart5rxdmarst(&mut self) -> Uart5rxdmarstW<Uartdma024Spec> {
        Uart5rxdmarstW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 RX DMA reset"]
    #[inline(always)]
    pub fn uart6rxdmarst(&mut self) -> Uart6rxdmarstW<Uartdma024Spec> {
        Uart6rxdmarstW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 RX DMA reset"]
    #[inline(always)]
    pub fn uart7rxdmarst(&mut self) -> Uart7rxdmarstW<Uartdma024Spec> {
        Uart7rxdmarstW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 RX DMA reset"]
    #[inline(always)]
    pub fn uart8rxdmarst(&mut self) -> Uart8rxdmarstW<Uartdma024Spec> {
        Uart8rxdmarstW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 RX DMA reset"]
    #[inline(always)]
    pub fn uart9rxdmarst(&mut self) -> Uart9rxdmarstW<Uartdma024Spec> {
        Uart9rxdmarstW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 RX DMA reset"]
    #[inline(always)]
    pub fn uart10rxdmarst(&mut self) -> Uart10rxdmarstW<Uartdma024Spec> {
        Uart10rxdmarstW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 RX DMA reset"]
    #[inline(always)]
    pub fn uart11rxdmarst(&mut self) -> Uart11rxdmarstW<Uartdma024Spec> {
        Uart11rxdmarstW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC RX DMA reset"]
    #[inline(always)]
    pub fn uartbmcrxdmarst(&mut self) -> UartbmcrxdmarstW<Uartdma024Spec> {
        UartbmcrxdmarstW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 RX DMA reset"]
    #[inline(always)]
    pub fn vuart0rxdmarst(&mut self) -> Vuart0rxdmarstW<Uartdma024Spec> {
        Vuart0rxdmarstW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 RX DMA reset"]
    #[inline(always)]
    pub fn vuart1rxdmarst(&mut self) -> Vuart1rxdmarstW<Uartdma024Spec> {
        Vuart1rxdmarstW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 RX DMA reset"]
    #[inline(always)]
    pub fn vuart2rxdmarst(&mut self) -> Vuart2rxdmarstW<Uartdma024Spec> {
        Vuart2rxdmarstW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 RX DMA reset"]
    #[inline(always)]
    pub fn vuart3rxdmarst(&mut self) -> Vuart3rxdmarstW<Uartdma024Spec> {
        Vuart3rxdmarstW::new(self, 15)
    }
}
#[doc = "UART RX DMA reset\n\nYou can [`read`](crate::Reg::read) this register and get [`uartdma024::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uartdma024::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uartdma024Spec;
impl crate::RegisterSpec for Uartdma024Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uartdma024::R`](R) reader structure"]
impl crate::Readable for Uartdma024Spec {}
#[doc = "`write(|w| ..)` method takes [`uartdma024::W`](W) writer structure"]
impl crate::Writable for Uartdma024Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UARTDMA024 to value 0"]
impl crate::Resettable for Uartdma024Spec {}
