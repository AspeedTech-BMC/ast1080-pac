...
impl W {
    #[doc = "Bit 0 - UART0 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart0txdmaintenbl(&mut self) -> Uart0txdmaintenblW<Udma30Spec> {
        Uart0txdmaintenblW::new(self, 0)
    }
    #[doc = "Bit 1 - UART1 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart1txdmaintenbl(&mut self) -> Uart1txdmaintenblW<Udma30Spec> {
        Uart1txdmaintenblW::new(self, 1)
    }
    #[doc = "Bit 2 - UART2 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart2txdmaintenbl(&mut self) -> Uart2txdmaintenblW<Udma30Spec> {
        Uart2txdmaintenblW::new(self, 2)
    }
    #[doc = "Bit 3 - UART3 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart3txdmaintenbl(&mut self) -> Uart3txdmaintenblW<Udma30Spec> {
        Uart3txdmaintenblW::new(self, 3)
    }
    #[doc = "Bit 4 - UART5 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart5txdmaintenbl(&mut self) -> Uart5txdmaintenblW<Udma30Spec> {
        Uart5txdmaintenblW::new(self, 4)
    }
    #[doc = "Bit 5 - UART6 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart6txdmaintenbl(&mut self) -> Uart6txdmaintenblW<Udma30Spec> {
        Uart6txdmaintenblW::new(self, 5)
    }
    #[doc = "Bit 6 - UART7 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart7txdmaintenbl(&mut self) -> Uart7txdmaintenblW<Udma30Spec> {
        Uart7txdmaintenblW::new(self, 6)
    }
    #[doc = "Bit 7 - UART8 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart8txdmaintenbl(&mut self) -> Uart8txdmaintenblW<Udma30Spec> {
        Uart8txdmaintenblW::new(self, 7)
    }
    #[doc = "Bit 8 - UART9 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart9txdmaintenbl(&mut self) -> Uart9txdmaintenblW<Udma30Spec> {
        Uart9txdmaintenblW::new(self, 8)
    }
    #[doc = "Bit 9 - UART10 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart10txdmaintenbl(&mut self) -> Uart10txdmaintenblW<Udma30Spec> {
        Uart10txdmaintenblW::new(self, 9)
    }
    #[doc = "Bit 10 - UART11 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uart11txdmaintenbl(&mut self) -> Uart11txdmaintenblW<Udma30Spec> {
        Uart11txdmaintenblW::new(self, 10)
    }
    #[doc = "Bit 11 - UART-BMC TX DMA interrupt enable"]
    #[inline(always)]
    pub fn uartbmctxdmaintenbl(&mut self) -> UartbmctxdmaintenblW<Udma30Spec> {
        UartbmctxdmaintenblW::new(self, 11)
    }
    #[doc = "Bit 12 - VUART0 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart0txdmaintenbl(&mut self) -> Vuart0txdmaintenblW<Udma30Spec> {
        Vuart0txdmaintenblW::new(self, 12)
    }
    #[doc = "Bit 13 - VUART1 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart1txdmaintenbl(&mut self) -> Vuart1txdmaintenblW<Udma30Spec> {
        Vuart1txdmaintenblW::new(self, 13)
    }
    #[doc = "Bit 14 - VUART2 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart2txdmaintenbl(&mut self) -> Vuart2txdmaintenblW<Udma30Spec> {
        Vuart2txdmaintenblW::new(self, 14)
    }
    #[doc = "Bit 15 - VUART3 TX DMA interrupt enable"]
    #[inline(always)]
    pub fn vuart3txdmaintenbl(&mut self) -> Vuart3txdmaintenblW<Udma30Spec> {
